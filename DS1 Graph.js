...
var nodes = new vis.DataSet([
  { id: "Player character", label: "Player character", shape: shape, value: 34, font: { background: fontBG }, color: "orange", system: "Player" },
  ...
  { id: "Souls", label: "Souls", shape: shape, value: 8, font: { background: fontBG }, color: "red", system: "Resources"},
  ...
  { id: "Combat magic/item", label: "Combat magic/item", shape: shape, value: 24, font: { background: fontBG }, color: "teal", system: "Items/equipment"},
...
var edges = new vis.DataSet([
  ...
  { from: "Player character", to: "Level geometry", label: "Traverses", arrows: "to", font: { align: "horizontal" }, relation: "Other" },
  ...
  { from: "Weapon/shield", to: "Swing", label: "Enables various", arrows: "to", font: { align: "horizontal" } },
  { from: "Weapon/shield", to: "Backstab", label: "Is used to", arrows: "to", font: { align: "horizontal" } },
  ...
  { from: "Combat magic/item", to: "Player character", label: "Transforms", arrows: "to", font: { align: "horizontal" } },
  ...
  { from: "Utility magic/item", to: "Souls", label: "Gives", arrows: "to", font: { align: "horizontal" } },
  ...
  { from: "Bonfire", to: "NPC", label: "Respawns", arrows: "to", font: { align: "horizontal" } },
  ...
  { from: "Day/night cycle", to: "AI", label: "Affects", arrows: "to", font: { align: "horizontal" } },
  { from: "Day/night cycle", to: "NPC", label: "Summons", arrows: "to", font: { align: "horizontal" } },
